...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"SouRce TeleGod")  
...
send(msg.chat_id_, msg.id_,' ※ تم تحديث السورس \n ※ لديك اخر اصدار لسورس تلي جود\n ※ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ℘' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ※ اصدار سورس تلي جود \n ※ الاصدار »{ v 1.6 }')
end
...
-------------
if text == "تحديثات تلي جود" and DevSoFi(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس تلي جود*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/sr_telegod"}},
}
...
send(msg.chat_id_, msg.id_, " امسكو غير الاسم بتاعو 😂\n الاسم القديم ["..DRAGONChengName..']')
...
send(msg.chat_id_, msg.id_, 1, "حذف معرفه اسرقوه بسرعه 😂 \n معرفه اهو  : [@"..DRAGONChengUserName..']')
...
send(msg.chat_id_, msg.id_, "امسكو حذف كل صوره الحيوان 😂🥺")
...
℘ ⦑ SOURCE TELEGOD ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
※ [Source Channel](t.me/Sr_telegod)
※ [Source Update ](t.me/sr_telegod)     
※ [Source developer](t.me/bk_zt)     
※ [TeleGod ProgRamMer](t.me/MIe3_bot) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉    
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if Get_info then
local TextS = "\n ※ اهلا بك في متجر ملفات تلي جود\n ※ ملفات السورس ↓\n•┉ • ┉ • ┉ ┉ • ┉ • ┉ • ┉ • ┉ • ┉•\n\n"
local TextE = "\n•┉ • ┉ • ┉ ┉ • ┉ • ┉ • ┉ • ┉ • ┉•\n ※ علامة تعني { ✔️ } ملف مفعل\n ※ علامة تعني { ✖ } ملف معطل\n ※ قناة سورس تلي جود ↓\n".." ※ [اضغط هنا لدخول](t.me/sr_telegod) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ※ عذرا الملف لايدعم سورس تلي جود \n") 
end
return false
end
...
if text == 'تفعيل منع التصفيه' and msg.reply_to_message_id_ == 0 and Mod(msg) then 
...
if text == 'تعطيل منع التصفيه' and msg.reply_to_message_id_ == 0 and Mod(msg) then 
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تلي جود').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تلي جود')
local DRAGON_Msg = {
'عمغي 🥺💕.',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'SouRce TeleGod.',url="t.me/sr_telegod"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."sr_telegod:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."sr_telegod:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."sr_telegod:insta_bot"..msg.chat_id_) == "open" then
...
database:del(bot_id.."sr_telegod:Tag:Admins:"..msg.chat_id_)
...
end --الكود حصري سورس تلي جود يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تلي جود').." غادر" or text == 'بوت غادر' then  
...
*３◂ اوامر ضع ~ اضف  .*
*４◂ اوامر مسح ~ حذف .*
*５◂ اوامر تنزيل+رفع+التغير .*
*６◂ اوامر الجروب .*
*７◂ اوامر التسليه .*
*８◂ اوامر مطور البوت .*
*９◂ اوامر مطور الاساسي .*
*１０◂ اوامر الاعضاء .*
*•┉ • ┉ • ┉ ┉ • ┉ • ┉ • ┉ • ┉ • ┉•*
...
keyboard.inline_keyboard = {
{
{text = '１', callback_data="/help1"},{text = '２', callback_data="/help2"},{text = '３', callback_data="/help3"},
},
{
{text = '４', callback_data="/help4"},{text = '５', callback_data="/help5"},
},
{
{text = '６', callback_data="/help6"},{text = '７', callback_data="/help7"},{text = '８', callback_data="/help8"},
},
{
{text = '９', callback_data="/help9"},{text = '１０', callback_data="/help10"},
},
{
{text = '⟦ 𝐒𝐎𝐔𝐑𝐂𝐄 ⟧', url="t.me/sr_telegod"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == "ايه رأيك في دا" or text == "ايه رأيك فدا" or text == "ايه رأيك في دي" or text == "ايه رأيك فدي" or text == "ايه رايك فدا" or text == "ايه رايك فدي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اوسخ من الوساخه 😂🥺"," اجمد من الجمدان 😶♥","ملكش داعوه 😾😹"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "هينه" or text == "رزله" or text == "هيني" or text == "رزلي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"انت ياض يعرص انت هفشخك لو متظبطش","ميستاهلش اكلمه سيبك منو اخره مداس","سيبك منو دا مظراط وهيفضل مظراط 😿😂"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "مح" or text == "بوسه" or text == "بوسي" or text == "مححح" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح💋","لا انا محترم 🙂😂","مش شغلانه بقا اتهد شويه 😒","محححح يا دينمي ع الجمااال 🌝💋"}send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
※مصه بالرد
※رزله بالرد 
※ايه رأيك في دا بالرد
※ايه رأيك في دي بالرد
※بتحب دا
•┉ • ┉ • ┉ ┉ • ┉ • ┉ • ┉ • ┉ • ┉•
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تلي جود')
